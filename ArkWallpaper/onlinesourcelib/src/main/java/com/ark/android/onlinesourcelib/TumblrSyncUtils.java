...
public class TumblrSyncUtils {
    ...
    public static void updatePeriodicSync(String oldAlbumName, String newAlbumName){
        Account account = TumblrGenericAccountService.GetAccount(ACCOUNT_TYPE);
        ...
        newBundle.putString("albumName" , newAlbumName);
    ...
    public static void TriggerRefresh(Bundle bundle) {
        ...
        ContentResolver.requestSync(
                TumblrGenericAccountService.GetAccount(ACCOUNT_TYPE), // Sync account
